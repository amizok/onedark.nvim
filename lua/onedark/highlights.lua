...
hl.treesitter = {
    ...
    TSConditional = {fg = c.green, fmt = cfg.code_style.keywords},
    ...
    TSInclude = colors.Fg,
    TSKeyword = {fg = c.green, fmt = cfg.code_style.keywords},
    TSKeywordFunction = {fg = c.green, fmt = cfg.code_style.functions},
    TSKeywordOperator =  {fg = c.fg, fmt = cfg.code_style.keywords},
    TSLabel = colors.Green,
    TSMethod = colors.Fg,
    ...
    TSRepeat = {fg = c.green, fmt = cfg.code_style.keywords},
    ...
    TSVariable = {fg = c.blue, fmt = cfg.code_style.variables},
